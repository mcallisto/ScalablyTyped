...
object Anon_Req {
  @scala.inline
  def apply(
    request: (/* span */ js.UndefOr[opentracingLib.opentracingMod.Span], /* req */ js.UndefOr[nodeLib.httpMod.IncomingMessage], /* res */ js.UndefOr[nodeLib.httpMod.ServerResponse]) => _ = null
  ): Anon_Req = {
