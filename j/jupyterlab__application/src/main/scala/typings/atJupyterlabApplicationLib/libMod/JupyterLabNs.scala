...
object JupyterLabNs extends js.Object {
  ...
  - Dropped {[ P in keyof @jupyterlab/application.@jupyterlab/application/lib.JupyterLab.IInfo ]:? @jupyterlab/application.@jupyterlab/application/lib.JupyterLab.IInfo[P]} */ trait IOptions extends js.Object {
    /**
  ...
  trait IPluginModule extends js.Object {
    /**
      * The default export.
      */
    var default: atJupyterlabApplicationLib.libMod.JupyterLabPlugin[_] | js.Array[atJupyterlabApplicationLib.libMod.JupyterLabPlugin[_]]
  }
