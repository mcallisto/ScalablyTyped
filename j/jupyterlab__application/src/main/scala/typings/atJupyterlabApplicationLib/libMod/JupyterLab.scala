package typings
package atJupyterlabApplicationLib.libMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("@jupyterlab/application/lib", "JupyterLab")
@js.native
/**
...
class JupyterLab ()
  ...
  def this(options: atJupyterlabApplicationLib.libMod.JupyterLabNs.IOptions) = this()
  ...
  /**
    ...
    */
  val info: atJupyterlabApplicationLib.libMod.JupyterLabNs.IInfo = js.native
  /**
  ...
  /**
    ...
    */
  def registerPluginModule(mod: atJupyterlabApplicationLib.libMod.JupyterLabNs.IPluginModule): scala.Unit = js.native
  /**
    * Register the plugins from multiple plugin modules.
    *
    * @param mods - The plugin modules to register.
    */
  def registerPluginModules(mods: js.Array[atJupyterlabApplicationLib.libMod.JupyterLabNs.IPluginModule]): scala.Unit = js.native
  /**
