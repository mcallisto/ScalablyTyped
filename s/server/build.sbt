...
name := "server"
version := "1.0-dt-20190522Z-e6851d"
scalaVersion := "2.13.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "csurf" % "1.9.0-dt-20190322Z-77bd51",
  "org.scalablytyped" %%% "express" % "4.17-dt-20190604Z-5e6a51",
  "org.scalablytyped" %%% "express-serve-static-core" % "4.16-dt-20190606Z-620cbf",
  "org.scalablytyped" %%% "express-session" % "1.15-dt-20190212Z-fbde1d",
  "org.scalablytyped" %%% "formidable" % "1.0.16-dt-20190322Z-1eca5c",
  "org.scalablytyped" %%% "helmet" % "0.0-unknown-dt-20190322Z-f65887",
