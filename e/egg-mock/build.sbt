...
name := "egg-mock"
version := "3.x-dt-20190327Z-b182b2"
scalaVersion := "2.13.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "depd" % "1.1-dt-20181116Z-a8988d",
  "org.scalablytyped" %%% "egg" % "2.22.2-d4aad9",
  "org.scalablytyped" %%% "egg-cookies" % "2.2.7-1ad96c",
  "org.scalablytyped" %%% "egg-core" % "4.17.2-ac45f2",
  "org.scalablytyped" %%% "egg-logger" % "2.4.1-e585db",
  "org.scalablytyped" %%% "egg-view" % "2.1.2-90eca1",
  ...
  "org.scalablytyped" %%% "koa-router" % "v7.x-dt-20190616Z-96307f",
  ...
  "org.scalablytyped" %%% "urllib" % "2.34.0-a279b6")
