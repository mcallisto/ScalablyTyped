...
- Dropped any extends any ? std.Pick<any, utility-types.utility-types/dist/mapped-types.SetComplement<keyof any, 'onChange' | 'onFocus' | 'onBlur'>> : never */ trait InputItemProps
