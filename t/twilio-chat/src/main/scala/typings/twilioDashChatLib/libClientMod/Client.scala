...
/**
  ...
  */
@JSImport("twilio-chat/lib/client", "Client")
@js.native
/**
...
class Client protected ()
  ...
  var connectionState: twilioDashChatLib.libClientMod.ClientNs.ConnectionState = js.native
  ...
  def createChannel(options: twilioDashChatLib.libClientMod.ClientNs.CreateChannelOptions): js.Promise[twilioDashChatLib.libDataChannelsMod.Channel] = js.native
  /**
  ...
  def getLocalChannels(sortingOptions: twilioDashChatLib.libClientMod.ClientNs.ChannelSortingOptions): js.Promise[js.Array[twilioDashChatLib.libDataChannelsMod.Channel]] = js.native
  /**
  ...
  def setPushRegistrationId(
    channelType: twilioDashChatLib.libClientMod.ClientNs.NotificationsChannelType,
  ...
  /**
    ...
    * @returns {Promise<void>}
    */
  def unsetPushRegistrationId(channelType: twilioDashChatLib.libClientMod.ClientNs.NotificationsChannelType): js.Promise[scala.Unit] = js.native
  /**
...
object Client extends js.Object {
  ...
  /**
    ...
    * @returns {Promise<Client>}
    */
  def create(token: java.lang.String): js.Promise[twilioDashChatLib.libClientMod.Client] = js.native
  def create(token: java.lang.String, options: twilioDashChatLib.libClientMod.ClientNs.Options): js.Promise[twilioDashChatLib.libClientMod.Client] = js.native
  /**
