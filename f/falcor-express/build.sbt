...
name := "falcor-express"
version := "0.1.2-dt-20190322Z-0a8460"
scalaVersion := "2.13.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "falcor" % "0.1-dt-20190212Z-92d1e3",
  "org.scalablytyped" %%% "falcor-http-datasource" % "0.1.3-dt-20190322Z-d6583d",
  "org.scalablytyped" %%% "falcor-json-graph" % "1.1.7-dt-20190322Z-ce1880",
