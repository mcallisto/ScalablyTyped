...
version := "0.1.4-16cb31"
scalaVersion := "2.13.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "csstype" % "2.6.5-da6515",
  "org.scalablytyped" %%% "fortawesome__fontawesome-common-types" % "0.2.19-2f023a",
  "org.scalablytyped" %%% "fortawesome__fontawesome-svg-core" % "1.2.19-1fe1a0",
