...
version := "4.0.0-dt-20190322Z-e7100a"
scalaVersion := "2.13.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-96ddb5",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-8d07c8",
