...
trait MergeRequests
  ...
  def all(
    hasProjectIdGroupIdOptions: (gitlabLib.Anon_ProjectId_1556160014 | gitlabLib.Anon_GroupId | js.Object) with gitlabLib.distInfrastructureMod.PaginatedRequestOptions
  ): js.Promise[
