...
trait Projects
  ...
  def upload(projectId: js.Any, content: js.Any, metadata: gitlabLib.distServicesMod.ProjectUploadMetadata): js.Promise[js.Object] = js.native
  def upload(
    projectId: js.Any,
    content: js.Any,
    metadata: gitlabLib.distServicesMod.ProjectUploadMetadata,
    options: gitlabLib.distInfrastructureMod.Sudo
  ): js.Promise[js.Object] = js.native
}
