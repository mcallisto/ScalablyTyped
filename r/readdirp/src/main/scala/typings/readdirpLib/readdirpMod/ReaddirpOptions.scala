...
trait ReaddirpOptions extends js.Object {
  ...
  var fileFilter: js.UndefOr[js.Function1[/* entry */ EntryInfo, scala.Boolean]] = js.undefined
...
object ReaddirpOptions {
  ...
  def apply(
    ...
    fileFilter: /* entry */ EntryInfo => scala.Boolean = null,
    ...
    if (fileFilter != null) __obj.updateDynamic("fileFilter")(js.Any.fromFunction1(fileFilter))
