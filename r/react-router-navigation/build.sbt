...
version := "1.0-dt-20190212Z-f70a9e"
scalaVersion := "2.13.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-navigation" % "3.0-dt-20190507Z-6faca8",
  "org.scalablytyped" %%% "react-router" % "5.0-dt-20190613Z-95ca44",
  "org.scalablytyped" %%% "react-router-navigation-core" % "1.0-dt-20181017Z-8d8eb9",
